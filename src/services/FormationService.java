   ...
   Cours  c= new Cours();
     ...
     public boolean supprimer(Formation f)
    {
       ...
       public boolean inscription( Formation f, int id) {
           ConnectionRequest con = new ConnectionRequest();
           String url = Statics.BASE_URL+"inscription/newInscri?"+"user="+1+"&formation="+f.getFormation_id();
    ...
    public boolean AjouterRating (int v, Formation f,int id ) throws IOException{
        ...
        ConnectionRequest con = new ConnectionRequest();
        String url =  Statics.BASE_URL+ "formation/rate?value="+v+"&user="+1+"&formation="+f.getFormation_id();
       ...
       public boolean ModifRating (int v, Formation f) throws IOException{

        ConnectionRequest con = new ConnectionRequest();
        String url =  Statics.BASE_URL+ "formation/rate/modif?value="+v+"&user="+1+"&formation="+f.getFormation_id();
