 ...
 */
public class User {
    private int user_id, num_tel, mailconfirme, numconfirme;
...
this.prenom=prenom;
    ...
    /**
     * @return the mailconfirme
     */
    public int getMailconfirme() {
        return mailconfirme;
    }

    /**
     * @param mailconfirme the mailconfirme to set
     */
    public void setMailconfirme(int mailconfirme) {
        this.mailconfirme = mailconfirme;
    }

    /**
     * @return the numconfirme
     */
    public int getNumconfirme() {
        return numconfirme;
    }

    /**
     * @param numconfirme the numconfirme to set
     */
    public void setNumconfirme(int numconfirme) {
