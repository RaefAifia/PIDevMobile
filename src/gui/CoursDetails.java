...
//        
       ...
       // lab.setUIID("Title");
           ImageViewer img = new ImageViewer();
            ...
            URLImage urlImage = URLImage.createToStorage(placeholder, f.getFile(), "http://localhost/PIDevWEB-main/public/images1/"+f.getFile());
    ...
    mf.playVideoOnNewForm(f.getMedia(), forme);
       ...
       getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e -> forme.showBack());
