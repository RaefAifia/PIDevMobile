...
//        
       ...
       // lab.setUIID("Title");
           ImageViewer img = new ImageViewer();
            ...
            URLImage urlImage = URLImage.createToStorage(placeholder, f.getImage(), "http://localhost/PIDevWEB-main/public/images1/"+f.getImage());
...
//         });
//        
String content = "inscription au nom de Mr ou Mme "+user.getNom()+" "+ user.getPrenom()+"\n evenement: "+f.getTitre()+ "\n Date : "+f.getDate()+"\n Prix : "+f.getPrix();
...
//        hi.show();
               ...
               Button inscrit1 = new Button("S'inscrire");
...
//              reserver.setVisible(false);
     ...
     FormationService.getInstance().inscription( f,1);
          ...
          //new QrFormation(res,forme,f).show();
           ...
           else {   inscrit1.addActionListener((evt) -> {
...
//              if(  FormationService.getInstance().isRated(1, f)==0)     {
                    ...
                    FormationService.getInstance().AjouterRating(s.getProgress(evt), f,1);
...
//                
     ...
     cn.add(l);
    cn.add(btnE);
        this.addAll(lab,lab1,lab2,lab3,lab4,lab5,lab8,lab6,lab7,img, inscrit,cn);
